...
set fish_color_normal "#f1fcf9" #the default color
set fish_color_command "#3da0bf" #the color for commands
set fish_color_quote "#74dc90" #the color for quoted blocks of text
...
set fish_color_error "#e1311c" #the color used to highlight potential errors
...
set fish_color_match "#181818" #the color used to highlight matching parenthesis
set fish_color_selection "#db86ba" #the color used when selecting text (in vi visual mode)
set fish_color_search_match "#181818" #used to highlight history search matches and the selected pager item (must be a background)
